...
window.yyyymmddhhmmss = 'YYYY-MM-DD HH:mm:ss'
...
# dash = new Daisho 'http://localhost:8081', modules, data, settings, true
dash = new Daisho 'https://api-dot-hanzo-staging-249116.appspot.com', modules, data, settings, true
